...
export const GALLERY_PROJECTS: GalleryProject[] = [
  ...
  {
    id: 23,
    title: "Black Chain Link Side Gate",
    category: "fencing",
    image: "/gallery/gallery-23.jpg",
    details: "Black coated chain link gate surface-mounted between residential buildings.",
  },
  {
    id: 24,
    title: "Pool Enclosure Chain Link",
    category: "fencing",
    image: "/gallery/gallery-24.png",
    details: "Black chain link fence enclosing a residential in-ground pool and patio.",
  },
  {
    id: 25,
    title: "Utility Excavation On Site",
    category: "excavation",
    image: "/gallery/gallery-25.jpg",
    details: "Excavator and trench box at work for underground utility installation.",
  },
  {
    id: 27,
    title: "Black Chain Link Yard Fence",
    category: "fencing",
    image: "/gallery/gallery-27.jpg",
    details: "Black coated chain link fence and gate enclosing a residential backyard.",
  },
  {
    id: 28,
    title: "Cream Vinyl Privacy Fence",
    category: "fencing",
    image: "/gallery/gallery-28.jpg",
    details: "Off-white vinyl privacy fence with matching gate on a residential property.",
  },
];
